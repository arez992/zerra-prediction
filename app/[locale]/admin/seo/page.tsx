        ...
        <section className="rounded-[2rem] border border-[#D4AF37]/20 bg-gradient-to-br from-[#101827] to-[#0A1220] p-6 shadow-2xl shadow-black/20 md:p-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-7 text-xs font-black uppercase tracking-[0.3em] text-[#D4AF37]">
                SEO Department
              </p>
              ...
              <p className="mt-4 max-w-3xl text-sm leading-7 text-white/55 md:text-base">
                Review SEO quality, duplicate risk,
                schema readiness, internal links,
                editorial status, approval, publishing,
                and page performance from one dedicated
                workspace.
              </p>
            </div>
          ...
          {loading ? (
            ...
            <div className="p-10 text-center">
              ...
              <p className="mt-2 text-sm text-white/45">
                Change the status filter or create a new SEO draft.
              </p>
            </div>
          ) : (
            <>
                        ...
                        >
                          ...
                          <td className="px-5 py-5">
                            <div className="flex min-w-[270px] flex-wrap gap-2">
                              <Link
                                href={`${base}/pages/${encodeURIComponent(
                                  row.id
                                )}/preview`}
                            ...
                            {!row
                              ...
                              row.draftStatus !==
                                ...
                                <p className="mt-2 text-[11px] leading-4 text-amber-200/65">
                                  Complete human review to unlock approval.
                                </p>
                              )}
                          </td>
                        </tr>
